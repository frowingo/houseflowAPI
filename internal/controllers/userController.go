...
func (r *UserController) NewUser(c *fiber.Ctx) error {
	...
	defer cancel()
	_, err := r.userService.CreateUser(ctx, *user)
	if err != nil {
...
func (r *UserController) ListUsers(c *fiber.Ctx) error {
	...
	ctx, cancel := requestContext(c)
	defer cancel()
	users, err := r.userService.ListByUsers(ctx)
	if err != nil {
		return helpers.RespondLocalizedError(c, r.localizer, err)
	}
...
func (r *UserController) GetUsersByHouse(c *fiber.Ctx) error {
	...
	ctx, cancel := requestContext(c)
	defer cancel()
	users, err := r.userService.GetUsersByHouse(ctx, houseId, userId)
	if err != nil {
		return helpers.RespondLocalizedError(c, r.localizer, err)
	}
...
func (r *UserController) UpdateProfile(c *fiber.Ctx) error {
	...
	ctx, cancel := requestContext(c)
	defer cancel()
	updated, err := r.userService.UpdateProfile(ctx, userId, *model)
	if err != nil {
		return helpers.RespondLocalizedError(c, r.localizer, err)
	}
...
func (r *UserController) GetImages(c *fiber.Ctx) error {
	...
	ctx, cancel := requestContext(c)
	defer cancel()
	images, err := r.userService.GetImagesByCategory(ctx, category)
	if err != nil {
		return helpers.RespondLocalizedError(c, r.localizer, err)
	}
...
func (r *UserController) GetImage(c *fiber.Ctx) error {
	...
	ctx, cancel := requestContext(c)
	defer cancel()
	image, err := r.userService.GetImageByPublicID(ctx, publicId)
	if err != nil {
		return helpers.RespondLocalizedError(c, r.localizer, err)
	}
...
func (r *UserController) UpdateImageAsset(c *fiber.Ctx) error {
	...
	ctx, cancel := requestContext(c)
	defer cancel()
	if err := r.userService.UpdateImageAsset(ctx, *model); err != nil {
		return helpers.RespondLocalizedError(c, r.localizer, err)
	}
...
func (r *UserController) CreateImageAsset(c *fiber.Ctx) error {
	...
	ctx, cancel := requestContext(c)
	defer cancel()
	if err := r.userService.CreateImageAsset(ctx, *model); err != nil {
		return helpers.RespondLocalizedError(c, r.localizer, err)
	}
